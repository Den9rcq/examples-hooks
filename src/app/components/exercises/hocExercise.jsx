...
import withIsAuth from "../examples/hoc/withIsAuth";
...
const HocExercise = () => {
    ...
    const ComponentWithAuth = withIsAuth(SimpleComponent);
    ...
    return (
        <CollapseWrapper title="Упражнение">
            ...
            <ComponentWithAuth isAuth={isAuth} onLogin={onLogin} onLogOut={onLogOut}/>
        </CollapseWrapper>
    );
};
